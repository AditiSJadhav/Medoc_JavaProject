...
public class AdminViewAppointmentControllerFX implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		doctorSpec.setCellValueFactory(new PropertyValueFactory<AppointmentWithDoctorAndPatient, String>("doctorSpecialization"));
...
if (UserSession.isAdmin()) {
		...
		TableColumn<AppointmentWithDoctorAndPatient, Boolean> col_action = new TableColumn<AppointmentWithDoctorAndPatient, Boolean>("Action");
		...
		col_action.setCellValueFactory(
				new Callback<TableColumn.CellDataFeatures<AppointmentWithDoctorAndPatient, Boolean>, ObservableValue<Boolean>>() {
					...
					@Override
					public ObservableValue<Boolean> call(TableColumn.CellDataFeatures<AppointmentWithDoctorAndPatient, Boolean> p) {
						return new SimpleBooleanProperty(p.getValue() != null);
					}
				});

		// Adding the Button to the cell
		col_action.setCellFactory(new Callback<TableColumn<AppointmentWithDoctorAndPatient, Boolean>, TableCell<AppointmentWithDoctorAndPatient, Boolean>>() {

			@Override
			public TableCell<AppointmentWithDoctorAndPatient, Boolean> call(TableColumn<AppointmentWithDoctorAndPatient, Boolean> p) {
		...
		ButtonCell() {
			...
			cellButton.setOnAction(new EventHandler<ActionEvent>() {
				...
				public void handle(ActionEvent t) {
					// get Selected Item
					AppointmentWithDoctorAndPatient currentPerson = (AppointmentWithDoctorAndPatient) ButtonCell.this.getTableView().getItems()
